...
1. Cebir veya Tehdit Kullanılmak Suretiyle Konut dokunulmazlığını İhlal (TCK m.116/4)

## 2. Gece Vakti Konut Dokunulmazlığının İhlali (TCK m.116/4)

## 3. Silahla Konut Dokunulmazlığının İhlali (TCK m.119/1-a)

4. Kişinin Kendisini Tanınmayacak Bir Hale Koyması Suretiyle Konut Dokunulmazlığının İhlali (TCK m.119/1-b)

5. İmzasız Mektupla veya Özel İşaretlerle Konut Dokunulmazlığını İhlal Suçu (TCK m.119/1-b)

## 6. Birden Fazla Kişi Tarafından Birlikte Konut Dokunulmazlığının İhlali Suçu (TCK m.119/1-c)

7. Var Olan veya Var Sayılan Suç Örgütlerinin Oluşturdukları Korkutucu Güçten Yararlanılarak Konut Dokunulmazlığını İhlal (TCK m.119/1-d)

8. Kamu Görevinin Sağladığı Nüfuz Kötüye Kullanılmak Suretiyle Konut Dokunulmazlığının İhlali (TCK m.119/1-e)
...
## Salt Eşya Muhafaza Edilen Eve Girmek Konut Dokunulmazlığının İhlali Suçunu Oluşturmaz
...
**TCK md. 116/1’de düzenlenen konut dokunulmazlığını ihlal suçu; konut, işyeri veya eklentisine “rızaya aykırı olarak girme” veya “rıza ile girilen yerden çıkmama” şeklinde iki seçimlik hareketle işlenebilir:**

1. Kişinin konutuna rızası dışında girilmesi

Kişinin konutuna rızası dışında girmek konut dokunulmazlığının ihlali suçunun oluşturur. Örneğin, kapıyı açan  ev sahibini iterek rıza göstermediği halde evine girmek konut dokunulmazlığının ihlali suçunun tipik bir şeklidir. Konuta girme konusunda hak sahibinin rızası açık veya zımni (örtülü) olabilir. Failin konuta veya eklentisine girme hususunda konutta hak sahibi olan kişinin rızası olmadığını, izin vermediğini veya kendisinin konut içerisine istenmediğini bilmesi yeterlidir.  Her olayın özelliğine göre konut sahibinin rızasının olup olmadığını değerlendirmek gerekir. Örneğin, bahçe kapısını duvarla çevirip bahçe giriş kapsını kilitleyip zil taktıran konut sahibinin konutun eklentisi niteliğinde olan bahçeye girilmesi konusunda rızası olmadığı açıktır. Rızaya aykırı bir şekilde bahçe dış kapısını zorlayarak konutun eklentisi olan bahçeye giren fail konut dokunulmazlığının ihlali suçuyla cezalandırılır.

Konuta girmek, failin bütün vücudu ile tamamen konuta girmesi demektir. Bu nedenle, konutun eklentisi içinde olmamak kaydıyla, pencereden içeriye bakma, kapıyı dinleme, camı tıkırdatma, dış kapı zilini çalma bu suçu oluşturmaz. Konuta veya eklentisine nereden girildiğinin önemi yoktur (Y4CD-K.2015/25782).

Evlilik birliğinde aile bireylerinden ya da konutun veya işyerinin birden fazla kişi tarafından ortak kullanılması durumunda, bu kişilerden birinin rızası varsa, konut dokunulmazlığının ihlali suçu oluşmaz. Ancak bunun için rıza açıklamasının meşru bir amaca yönelik olması gerekir (TCK m.116/3). Meşru bir amaç için gösterilmiş rıza olması kaydıyla aynı evde yaşayan herkes veya aile konutunda aile üyelerinden her biri tek başına konuta girme konusunda rıza açıklamaya ehildir. Meşru amacın, hukuka aykırı olmaması, diğer hak sahipleri tarafından kabul edilebilir nitelikte olması gerekir. Birlikte kalan kişilerin veya aile üyelerinin açık veya örtülü bir rızasının olmadığı ya da böyle bir rızanın bulunmayacağının varsayılması gereken hâllerde konut dokunulmazlığının ihlali suçunun meydana gelmiş olduğu kabul edilmelidir (CGK-K.2020/363). Örneğin, eşlerden birinin  cinsel birliktelik yaşamak amacıyla ortak konuta yabancı bir kimsenin girmesine rıza göstermesi halinde, bu rıza meşru bir amaca yönelik olmadığından ve diğer eşin bunu kabul etmeyeceği aşikar olduğundan eve giren şahıs konut dokunulmazlığının ihlali suçunu işlemiş olur.

Konutun aile bireylerinden ya da birden fazla kişi tarafından birlikte kullanılması durumunda, birlikte oturanlardan birinin konuta girme konusunda geçerli rızasından söz edebilmek için bu kişinin rızasına dayanarak giren failin konutta oturan diğerlerinin haklarını ihlal etmemesi gerekir. Başka bir anlatımla, konutu birlikte kullananların failin konuta girmesine ilişkin rızasının geçerli olması için, rıza açıklamasının meşru bir amaca yönelik, hukuka uygun olması yanında eylemin konutu kullanan diğer kişilerinhaklarını ihlal edicinitelikte olmaması gerekir (Y18CD-K.2016/7044).

Konutun ortak olarak kullanılması halinde konutta oturanların eylem sırasında konutta bulunmaları suçun oluşumu bakımından gerekli değildir. Konutta yaşayanların sayısının veya sanığın bu kişilerin sayısını yahut kim olduklarını bilmesinin de suçun oluşumu bakımından önemi yoktur. Konuta izinsiz girme eylemi o konutta yaşayan kişilerin sayısından bağımsız olarak tek suç oluşturur (Y4CD-K.2015/27315).

2. Konuta rıza ile girildikten sonra, rızaya aykırı bir şekilde çıkılmaması

Hak sahibinin rızası ile konuta girildikten sonra hak sahibi olan kişinin rızasına aykırı bir şekilde konuttançıkılmamasıkonut dokunulmazlığının ihlali suçuna vücut verir. Suçun bu şeklinde, konuta girilirken konut sahibinin rızası vardır. Ancak, girildikten belli bir süre sonra rıza ortadan kalkmakta, konut sahibi konutunun terk edilmesini istemesine rağmen fail konuttan çıkmamaktadır. Rıza geri alındıktan sonra konuttan çıkmayan fail konut dokunulmazlığını ihlal suçunu işlemiş olur. Örneğin, alacak meselesini konuşmaya gelen alacaklının  konutuna girmesine izin veren borçlu, belli bir süre sonra tartışma çıkması üzerine, alacaklının konutundan çıkmasını istediğinde, konuttan çıkmayan alacaklı konut dokunulmazlığının ihlali suçunu işlemiş olur.

Konuttan çıkmamak, konut sahibinin rızası ile girilen konuttan, söz, hareket ve tavırlarıyla  çıkmaya davet edilmesine rağmen failin çıkmamasıdır (Y4CD-K.2015/25782).
...
İşyeri dokunulmazlığını ihlal suçunun  cezası,  6 aydan 2 yıla kadar hapis cezası veya adli para cezadır (TCK md.116/1).  Yani, işyeri konut dokunulmazlığının ihlali halinde, mahkemenin, faile hapis cezası veyaadli para cezasıvermek konusunda seçimlik yaptırım uygulama yetkisi vardır. Cebir veya tehdit kullanılmak suretiyle ya da gece vakti işlenmesi halinde, suçun cezası 1 yıldan 3 yıla kadar hapis cezasıdır (TCK md.116/4).
...
Yargıtay tarafından avlunun, maddi bir kapısı olmasa da etrafının taştan bir duvarla çevrildiği, özel bir hâkimiyet alanı altında bulunduğu ve bu hâliyle başkalarının buraya girmesine rıza gösterilmeyeceğini belirtecek şekilde bir engelle dış dünyadan ayrılmış olması nedeniyle konutun eklentisi niteliğini kazandığı, buraya girilmesinin konut dokunulmazlığının ihlali suçunu oluşturacağı kabul edilmektedir (CGK-K.2018/623).
...
Açık bir rızaya gerek duyulmaksızın girilmesi mutat olan yerler dışında kalan işyerleri ve eklentilerine girilmesi halinde;işyeri eklentisinin dokunulmazlığını ihlal suçunun  cezası, 6 aydan 2 yıla kadar hapis cezası veya adli para cezadır. (TCK md.116/1).

## Konut dokunulmazlığının ihlali suçunun daha fazla cezayı gerektiren nitelikli halleri şunlardır:

I.Konut dokunulmazlığının ihlali suçunun,cebirveyatehditkullanılmak suretiyle ya dagece vaktiişlenmesi halinde, bir yıldan üç yıla kadar hapis cezasına hükmolunur (TCK m.116/4).

**II.Konut dokunulmazlığının ihlali suçunun aşağıdaki nitelikli şekillerde işlenmesi halinde faile verilecek ceza bir kat artırılır (TCK m.119):**
...
Konut dokunulmazlığının ihlali suçununcebirveyatehditkullanılmak suretiyle ya da gece vakti işlenmesi halinde, suçun cezası 1 yıldan 3 yıla kadar hapis cezasıdır (TCK md.116/4).

Cebir, fiziki güç kullanarak bir kimsenin belli bir davranışta bulunmaya zorlanmasıdır. Örneğin, konutunun kapısını açan bir kimseyi iterek içeri giren kişi cebir kullanmak suretiyle konut dokunulmazlığının ihlali suçunu işlemiş olur. Cebir, konut dokunulmazlığının ihlali için uygulanmış olmalıdır. Konuta girdikten sonra konuttaki kişilere karşıkasten yaralamafiilleri cebir olarak kabul edilemez. Çünkü, cebir konut dokunulmazlığını bozmak için bir araç olarak kullanılmalıdır.

TCK’nın 116/4. maddesinde düzenlenen cebir suretiyle konut dokunulmazlığını bozmak suçunun oluşabilmesi için, sanık tarafından kişilere karşı yöneltilen şiddet eylemi ile konut dokunulmazlığının bozulması arasında nedensellik bağının bulunması, şiddetin konut dokunulmazlığını bozmak amacına yönelmesi ve bu amacın gerçekleşmesi için araç olarak kullanılması gereklidir (Y18CD-K.2019/2575).

Tehdit, gelecekte muhtemelen haksız bir zarara veya kötülüğe uğratılacağının bir kimseye bildirilmesidir. Örneğin, “çekil kapıdan içeri gireceğim yoksa seni döveceğim” diyerek  konuta giren kişi tehdit kullanmak suretiyle konut dokunulmazlığının ihlali suçunu işlemiştir.

TCK’nın 116/4. maddesinde düzenlenen cebir veya tehdit suretiyle konut dokunulmazlığını ihlâl etme suçunun oluşabilmesi için, sanık tarafından kişilere karşı yöneltilen şiddet eylemi ile konut dokunulmazlığının bozulması arasında nedensellik bağının bulunması, şiddetin veya tehditin konut dokunulmazlığını bozma amacına yönelmiş olması ve bu amacın gerçekleşmesi için araç olarak kullanılması gerekir. Yargılamaya konu somut olayda, sanığın konuta girdikten sonra mağduru yaralayıp, tehdit ettiğinin kabul edilmesi karşısında, gündüz saatlerinde gerçekleştirilen konut dokunulmazlığını ihlal etme suçunun ne şekilde cebir veya tehdit kullanılarak işlendiği açıklanmadan ve sanığın tehdit olarak kabul edilen sözleri hükümde açıklanmadan yetersiz gerekçeyle TCK’nın 116/4. maddesi gereğince hüküm kurulması, bozma nedenidir (Y18CD-K.2018/9961).

5237 sayılı TCK’nın 6. maddesinin (e) bendindegece vakti, güneşin batmasından bir saat sonra başlayan ve doğmasından bir saat evvele kadar devam eden zaman dilimi olarak tanımlanmaktadır. Konut dokunulmazlığının ihlali suçunun geceleyin işlendiğinin kabulü için suçun işlendiği zamanın tam olarak tespit edilmesi gerekir. Suçun işlendiği zaman, gece vakti olarak kabul edilen zaman dilimi içerisinde ise, konut dokunulmazlığının ihlali suçunun geceleyin işlenmesi nedeniyle fail suçun daha fazla cezayı gerektiren nitelikli haliyle cezalandırılacaktır. Suçun işlendiği zamanın tam olarak tespiti mümkün değilse,şüpheden sanık yararlanır ilkesigereği bu durumun sanık lehine yorumlanması gerekir.

Konut dokunulmazlığının ihlali suçunungece vaktiişlenmesi halinde, suçun cezası 1 yıldan 3 yıla kadar hapis cezasıdır (TCK md.116/4).

Müştekinin kovuşturma aşamasında alınan beyanlarında, bahse konu olayın akşam ezanı okunmak üzereyken gerçekleştiğini beyan ettiği, suç tarihinde akşam ezanı vaktinin saat 16.55 olduğu, UYAP’tan alınan güneşin doğuş ve batış çizelgesine göre suç tarihinde gece vaktinin saat 17.48’de başladığı, bu suretle şüpheden sanık yararlanır ilkesi gereği hırsızlık ve konut dokunulmazlığının ihlali suçlarının sanık lehine gündüz sayılan zaman dilimi içerisinde işlendiğinin kabul edilmesi gerektiği gözetilmelidir (Y2CD-K.2017/9232).

5237 sayılı TCK’ya göre silah kavramından kast edilen; ateşli silahlar, patlayıcı maddeler, saldırı ve savunmada kullanılmak üzere yapılmış her türlü kesici, delici veya bereleyici aletler, saldırı ve savunma amacıyla yapılmış olmasa bile fiilen saldırı ve savunmada kullanılmaya elverişli diğer şeylerdir. Örneğin, bıçak, sopa, taş, tabanca vb. aletler silah olduğu gibi yazı yazmak için kullanılan kalem ile bir kişiye saldırılırsa bu kalem silah olarak kabul edilir. Çatal, kaşık, tabak gibi mutfak aletleri, küllük, vazo vs. gibi saldırı ve savunmada kullanılan tüm eşyalar silah olarak kabul edilir (TCK m.6/1-f).

Silahın konut dokunulmazlığının ihlal suçunun nitelikli unsuru olarak kabul edilebilmesi için, konuta girilmesi veya girildikten sonra kalmak için araç olarak kullanılması gerekir. Örneğin, belinde silah olmasına rağmen bunu kullanmadan konuta cebir uygulayarak giren kişi içerde silahla konut sahibini yaralarsa, silah konuta girmek veya konuttan çıkmamak için bir araç olarak değil, kasten yaralama suçu işlemek için kullanıldığından silahla konut dokunulmazlığının ihlali suçu değil, TCK 116/4’deki cebir kullanmak suretiyle konut dokunulmazlığının ihlali suçu oluşur.

Sanığın, mağdurlara ait evin kapısını tekmeleyip içeri girdikten sonra, elindeki bıçakla mağdurların bulunduğu odaya girip tehdit ve yaralama eylemlerini gerçekleştirdiği, mağdurlar görmeden rızaları dışında eve girilmesiyle konut dokunulmazlığının ihlali suçunun oluştuğu, kapının tekmeyle açılıp eve girilmesi sırasında mağdurlara silahtan sayılan bıçağın gösterilmemesi ve bıçağın eve girmeyi kolaylaştırmak amacıyla kullanılmaması nedeniyle TCK’nın 119/1-a maddesinin uygulanma imkanının bulunmadığı, her ne kadar sanık eve girdikten sonra elindeki bıçakla mağdurların bulunduğu odaya girip tehdit ve yaralama eylemlerini gerçekleştirmişse de, bıçağın konuttan çıkmamak için değil, tehdit ve yaralama suçlarının işlenmesi amacıyla kullanıldığı gözetil (Y4CD-K.2015/25782).

Konut dokunulmazlığının ihlali suçunun silahla işlenmesi halinde, verilecek ceza bir kat artırılır (TCK m.119/1-a-son). Örneğin, suçun cebir uygulanarak işlenen nitelikli şeklinin cezası 1 yıldan 3 yıla kadar hapis cezası olmasına rağmen konut dokunulmazlığının ihlali suçunun silahla işlenmesi halinde ceza bir kat artırılarak 2 yıldan 6 yıla kadar hapis cezasına hükmedilecektir.

Kuru sıkı tabancayı dayayıp ‘‘seni öldürürüm’’ diye tehdit ederek zorla müştekinin ikametine girdiğinin belirtilmesi karşısında; sanık hakkında TCK’ nın 116/4 ve 119/1-a maddelerinin uygulanması gerektiğinin gözetilmemesi, bozma nedenidir (Y4CD-K.2019/5253)

Konuta girmek veya konutta kalmak için silahı araç olarak kullanan fail konut dokunulmazlığının nitelikli haliyle cezalandırılacağından ayrıcasilahla tehdit suçunedeniyle cezalandırılamaz.

Sanık …‘nın, olay günü kavga ettiği mağdur kardeşinin evine elinde bıçakla ve kapısını tekmelemek suretiyle içeriye girmeye çalıştığının iddia ve kabul edilmesi karşısında; sanığın sözkonusu eylemlerini mağdurun evine girerken cebir ve tehditte bulunmak suretiyle gerçekleştirdiği halde, bu durumun konut dokunulmazlığının ihlali suçunun nitelikli halini oluşturduğu gözetilmeyerek sanık hakkında ayrıca silahla tehdit eyleminden de mahkumiyet hükmü kurulması, bozma nedenidir (Y4CD-K.2020/20004).

Konut dokunulmazlığının ihlali suçunun işlenmesinde kolaylaştırıcı bir vasıta olarak kişinin kendisini tanınmayacak bir hale koyması suçun nitelikli hallerinden biri olarak kabul edilmiştir. Kendini tanınmayacak hale koyma şeklindeki nitelikli unsurun gerçekleşmesi için failin mağdurla yüz yüze gelmesi, sakal, bıyık veya maske takma, kıyafetinde değişiklik yapma gibi dış görünümünü ve dolayısıyla kimliğini değiştirecek şekildeki davranışlar sergilenmelidir. Örneğin yüzüne kar maskesi takarak kendisini tanınmayacak hale koymak suretiyle konut dokunulmazlığını ihlal suçu işleyen sanığın cezasından, TCK’nın 119/1-b maddesi uyarınca arttırım yapılması gerekir (Y4CD-K.2014/34399).

Sanığın önceden hazırladığı kıyafetleri ve maskeyi giyip kendisini tanınmayacak bir hale koyarak katılana ait evin kapısını kırmak suretiyle içeri girdiği, evde karşılaştığı katılan ile boğuştukları ve silahla ateş ederek katılanı yaraladığı anlaşılan olayda; katılanın konutuna rızasına aykırı olarak girilmesiyle konut dokunulmazlığının ihlâli suçunun oluştuğu, eve girilmesi sırasında katılana karşı silah gösterilmediği gibi silahın eve girmeyi kolaylaştırmak amacıyla da kullanılmadığı, evin içerisinde yaşanan olayda ise silahın konuttan çıkmamak için değil, kasten öldürmeye teşebbüs suçunun işlenmesi amacıyla kullanıldığı dikkate alınarak, sanığın eylemine uyan TCK’nun 116/1 ve 119/1-b maddeleri uyarınca cezalandırılması gerekir (Y1CD-K.2016/1643).

Konut dokunulmazlığının ihlali suçunun kişinin kendisini tanınmayacak hale koyması suretiyle işlenmesi halinde, verilecek ceza bir kat artırılır (TCK m.119/1-b). Örneğin, suçun temel şeklinin cezası 6 aydan yıldan 2 yıla kadar hapis cezası olmasına rağmen konut dokunulmazlığının ihlali suçunun kişinin kendisini tanınmayacak bir hale koyması suretiyle işlenmesi halinde ceza bir kat artırılarak 12 aydan 4 yıla kadar hapis cezasına hükmedilecektir.

İmzasız mektup ile işlenen nitelikli halin uygulanabilmesi için, mektubun kimin tarafından yazıldığının muhatabınca anlaşılamamış olması gerekmektedir. Kanundaki mektup deyimi; faks, e-mail ve telgraf yoluyla yapılan eylemleri de kapsamaktadır.

Konut dokunulmazlığının ihlali suçunun özel işaretlerle işlendiğinin kabul edilebilmesi için özel işaretlerle işlenen eyleminin kimin tarafından gerçekleştirildiğinin muhatabınca anlaşılmamış olması gerekir. Örneğin, bahçe kapısına çarpı işareti koyarak “bir saate kadar bahçenizin kapısını açmazsanız zarar görürsünüz” şeklinde not bırakarak bahçenin kapısının mağdur tarafından açılmasını sağlayan fail özel işaretlerle ve imzasız mektupla konut dokunulmazlığının ihlali suçunu işlemiş alur.

Konut dokunulmazlığının ihlali suçunun imzasız mektupla veya özel işaretlerle işlenmesi halinde, verilecek ceza bir kat artırılır (TCK m.119/1-b). Örneğin, suçun temel şeklinin cezası 6 aydan yıldan 2 yıla kadar hapis cezası olmasına rağmen konut dokunulmazlığının ihlali suçunun imzasız mektupla veya özel işaretlerle işlenmesi halinde ceza bir kat artırılarak 12 aydan 4 yıla kadar hapis cezasına hükmedilecektir.

Konut dokunulmazlığını bozma (ihlal) suçunun birden fazla kişi tarafından birlikte işlenmesi, eylemin (fiilin) tehlikesini artırmakta ve mağdurun kendisini savunma olanaklarını da azaltmaktadır. Başka bir deyişle, birden fazla kişi (birçok kişi), ile bu eylemin gerçekleştirilmesi, bir açıdan saldırının yoğunluğunu yükseltmekte buna karşılık diğer taraftan da mağdurun kendini koruma yoğunluğunu ciddi şekilde azaltmaktadır. Bundan dolayı konut dokunulmazlığını bozma suçunun birden fazla kişi tarafından birlikte işlenmesi, 5237 Sayılı TCY’nın 119.maddesinin 1.fıkrasının (c) bendi uyarınca ağırlatıcı neden olarak kabul edilmiştir. Birden çok olan kişilerin konut dokunulmazlığını bozma eylemini gerçekleştirmeden önce, aralarında anlaşmış olmaları şart değildir. Sanıklar arasında herhangi bir anlaşmanın varlığı, mağdur açısından meçhul bir özellik taşımaktadır. Bunun için anlaşmanın bulunması zorunlu değildir. Yalnız, eylemin işlendiği yerde, sanıkların birlikte hareket etmeleri yeterlidir (Y2CD-K.2013/19335).

Konut dokunulmazlığının ihlali suçunun birden fazla kişi tarafından birlikte işlenmesi halinde, verilecek ceza bir kat artırılır (TCK m.119/1-c).

Var olan veya var sayılan suç örgütlerinin oluşturdukları korkutucu güçten yararlanılarak konut dokunulmazlığının ihlali failin organize bir gücün korkutuculuğundan yararlanması nedeniyle nitelikli hal olarak kabul edilmiştir. Failin yasadışı suç örgütünün üyesi olması şart değildir, önemli olan suç örgütünün oluşturduğu korkutucu gücün kullanılmasıdır. Gerçekte ismi kullanılan suç örgütünün var olup olmadığı da mühim değildir. Suç örgütünün isminin kullanılarak konuta girilmesi veya girdikten sonra konuttan çıkılmaması halinde var olan veya var sayılan suç örgütlerinin oluşturdukları korkutucu güçten yararlanılarak konut dokunulmazlığını ihlal suçu oluşur.

Suç örgütünün niteliği önemli değildir. Örgüt, dini, siyasi, terör veya bir mafya örgütü olabilir.

Konut dokunulmazlığının ihlali suçunun var olan veya var sayılan suç örgütlerinin oluşturdukları korkutucu güçten yararlanılarak işlenmesi halinde, verilecek ceza bir kat artırılır (TCK m.119/1-d).

Kamu görevinin sağladığı nüfuz kötüye kullanılmak suretiyle konut dokunulmazlığının ihlalinin nitelikli hal kabul edilmesinin nedeni kamu görevinin sağladığı nüfuzun mağdur üzerinde daha kolay etki yaratarak suçun işlenmesini kolaylaştırmasıdır. Kamu görevlisi, görevinden kaynaklanan yetki ve otoriteyi kullanarak suçu işlemektedir. Bu nitelikli halin uygulanabilmesi için failin görevini yerine getirdiği esnada, görevin sağladığı nüfuzu kötüye kullanrak konuta girmesi veya çıkmaması gerekir. Suçun nitelikli halinin oluşup oluşmadığının anlaşılabilmesi için, failin görevinin kapsamı belirlenmeli, failin görevinin mağdur üzerinde ne ölçüde etkili olabileceği ortaya konularak kamu görevinin sağladığı nüfuzun kötüye kullanılarak konut dokunulmazlığının ihlal edilip edilmeyeceği tespit edilmelidir.

Konut dokunulmazlığının ihlali suçunun kamu görevinin sağladığı nüfuz kötüye kullanılmak suretiyle işlenmesi halinde, verilecek ceza bir kat artırılır (TCK m.119/1-e).
...
Suçundava zamanaşımısüresi 8 yıldır. Failin hapis cezası ile cezalandırılması halinde iseceza zamanaşımı10 yıldır. Yani, fail hakkındaki mahkumiyet hükmü 10 yıl içinde infaz edilmezse hapis cezası zamanaşımı nedeniyle ortadan kalkar.
...
Bu açıklamalar ışığında somut olay değerlendirildiğinde; Sanık … ile mağdur …`nin olay günü katılan …’nin evine gittikleri, burada bir süre alkol aldıktan sonra sanık ile mağdurun tartışmaya başladıkları, tartışma sırasında mağdura yumrukla vuran sanığın, katılanın da yardımıyla dışarı çıkartıldığı,

aynı gün sabah saatlerinde geri gelerek katılanın kapısını çalan sanığın, kapının açılmaması üzerine kapıyı tekmeleyerek kırıp içeri girdiği ve yumrukla vurmak suretiyle hem katılanı hem de mağduru basit tıbbi müdahale ile giderilebilecek şekilde yaraladığı olayda;

Sanığın, katılanın konutuna girmek için kapıyı kırması eyleminin, kişilere karşı değil eşya aleyhine gerçekleştirilmesi dolayısıyla cebir niteliğinde bulunmadığı,

Sanığın belirtilen şekilde katılanın konutuna girdikten sonra katılana ve mağdura karşı uyguladığı cebrin ise, katılan ve tanık ….’nın beyanları gözetildiğinde, evde kalmaya değil, mağduru evden çıkarmaya yönelik olması ve konut dokunulmazlığının ihlâli amacının gerçekleştirilmesi için bir araç olarak kullanılmaması karşısında, sanığın eyleminin TCK`nın 116. maddesinin dördüncü fıkrasında öngörülen nitelikli hâlin cebir unsurunu oluşturmadığı kabul edilmelidir (Yargıtay CGK - Karar : 2018/385).
...
Mağdur …’nun aşamalardaki ifadelerinde, suçun işlendiği evin eski evi olduğunu, suç tarihinde söz konusu evi depo olarak kullandığını belirtmesi karşısında; salt eşya muhafazası için kullanılan, suç tarihinde faal olarak kullanılmayan, müştekinin eski evi niteliğindeki ikamete girilmesinin konut dokunulmazlığının ihlali suçunu oluşturmayacağı bu nedenle sanığın konut dokunulmazlığının ihlali suçundan beraatine karar verilmesi gerekirken yazılı şekilde mahkumiyetine hükmedilmesi, bozma nedenidir (Yargıtay 17. Ceza Dairesi         2017/4384 E.  ,  2018/17050 K.).

Konut dokunulmazlığını ihlal suçu; çoğunluklatehdit suçu,mala zarar verme suçu,hırsızlık suçuvb. gibi suçlarla birlikte işlenmektedir. Kişinin konutunda huzur ve sükunu; işyerinde, çalışma hürriyetini engelleyen fiileri cezalandıran bu suça ilişkin iddia veya savunmanın bir avukat yardımı ile yapılması hak kaybını önleyecektir.
