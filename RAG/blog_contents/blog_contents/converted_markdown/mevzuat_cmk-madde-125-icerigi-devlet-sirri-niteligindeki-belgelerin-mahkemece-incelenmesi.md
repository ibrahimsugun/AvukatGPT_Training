...
## CMK Madde 125 Gerekçesi

## CMK 125 (İçeriği Devlet Sırrı Niteliğindeki Belgelerin Mahkemece İncelenmesi)  Emsal Yargıtay Kararları
...
Bu madde, resmî dairelerdeki dosya ve diğer belgelerin delil olarak mahkemelerde kullanılabilmesi açısından önemli değişiklikler getirmiş ve öncelikle Devletin güvenliği veya temel dış yararları unsurları kullanılmıştır.
