...
Haksız tahrik,kişinin haksız bir fiilin kendisinde meydana getirdiği hiddet veya şiddetli elemin etkisi altında suç işlemesi halinde ceza sorumluluğunu azaltan birceza indiriminedenidir.
...
Sanık, ceza mahkemesi tarafındanhaksız tahrik indirimiyapılarak cezalandırılmıştır. Ceza davasının sanığı olan kişi, aynı zamanda maddi tazminat davasının davalısıdır.Haksız tahriknedeniyle ceza mahkemesinde ceza indirimi yapılan davalı aleyhine hukuk mahkemesinde maddi tazminat hesaplanırken maddi tazminattan indirim yapılması gerekir (Yargıtay 4. Hukuk Dairesi – Karar No: 2013/4685).
